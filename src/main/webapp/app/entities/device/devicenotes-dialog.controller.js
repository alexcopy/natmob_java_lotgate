(function() {
    ...
    DeviceNotesDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Device', 'Tank'];

    function DeviceNotesDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Device, Tank) {
        var vm = this;
