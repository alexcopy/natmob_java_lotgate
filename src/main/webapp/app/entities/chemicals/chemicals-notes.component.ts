...
@Component({
    selector: 'jhi-chemicals-notes',
    templateUrl: './chemicals-notes.component.html'
})
export class ChemicalsNotesComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/chemicals-notes'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    clear() {
        this.page = 0;
        this.currentSearch = '';
        this.router.navigate(['/chemicals-notes', {
            page: this.page,
            sort: this.predicate + ',' + (this.reverse ? 'asc' : 'desc')
        }]);
        this.loadAll();
    ...
    trackId (index: number, item: ChemicalsNotes) {
        return item.id;
    }
