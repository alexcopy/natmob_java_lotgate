...
@Component({
    selector: 'jhi-temp-meter-notes',
    templateUrl: './temp-meter-notes.component.html'
})
export class TempMeterNotesComponent implements OnInit, OnDestroy {

    tempMeters: TempMeterNotes[];
    currentAccount: any;
    ...
    trackId (index: number, item: TempMeterNotes) {
        return item.id;
    }
